...
namespace VirtualPhenix.Nintendo64.PokemonSnap
{
    public class CRGAnimator
    {
        ...
        public float Compute(long field, long time)
        {
            return Interpolators[field].Compute(time);
        }
        ...
        public class AObj
        {
            ...
            // Este método debe estar definido en tu sistema
            private float GetPointHermite(float p0, float p1, float m0, float m1, float t)
            {
                // Placeholder (reemplaza esto por tu implementación real)
                float t2 = t * t;
                float t3 = t2 * t;

...
namespace VirtualPhenix.Nintendo64
{
    ...
    {
        GfxBuffer CreateBuffer(long wordCount, GfxBufferUsage usage, GfxBufferFrequencyHint hint, byte[] initialData = null);
        ...
        void UploadBufferData(GfxBuffer buffer, long dstByteOffset, byte[] data, long srcByteOffset = 0, long byteCount = -1);
        void UploadTextureData(GfxTexture texture, long firstMipLevel, List<ArraySegment<byte>> levelDatas);
        ...
        bool QueryReadbackFinished(uint[] dst, long dstOffs, GfxReadback o);
